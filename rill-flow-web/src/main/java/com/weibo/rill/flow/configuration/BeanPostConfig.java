            ...
            try {
                ...
                asyncExecution(statisticExecutor, () -> {
                    ...
                    if (StringUtils.isBlank(executionId) || notifyType == null) {
                        ...
                        systemMonitorStatistic.recordNotify(executionCost, executionId);
            ...
            try {
                ...
                asyncExecution(statisticExecutor, () -> {
                    ...
                    if (StringUtils.isBlank(executionId)) {
                        ...
                        tenantTaskStatistic.finishDAGCount(executionId, dagInfo);
                    }
                });
            }
        };
            ...
            try {
                ...
                asyncExecution(statisticExecutor, () -> {
                    ...
                    if (StringUtils.isBlank(executionId) || taskInfo == null) {
                        ...
                        tenantTaskStatistic.recordTaskRun(executionId, taskInfo);
                    }
                });
            }
        };
