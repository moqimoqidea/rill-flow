...
public class ChoiceTaskRunner extends AbstractTaskRunner {
    ...
    protected ExecutionResult doRun(String executionId, TaskInfo taskInfo, Map<String, Object> input) {
        ...
        taskInfo.setSubGroupIndexToIdentity(Maps.newConcurrentMap());
        ...
        choices.stream()
                ...
                .forEach(it -> {
                    ...
                    taskInfo.getNext().addAll(subTaskInfos);
        ...
        TaskStatus taskStatus = DAGWalkHelper.getInstance().calculateTaskStatus(taskInfo.getChildren().values());
