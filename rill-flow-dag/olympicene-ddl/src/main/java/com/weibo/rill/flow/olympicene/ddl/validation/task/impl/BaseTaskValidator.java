...
public class BaseTaskValidator implements TaskValidator<BaseTask> {
    ...
    public void validate(BaseTask task, Map<String, BaseResource> resourceMap) {
        ...
        assertTask(task, t -> !StringUtils.isEmpty(t.getCategory())
                , DDLErrorCode.TASK_INVALID.getCode(), String.format(DDLErrorCode.TASK_INVALID.getMessage(), task.getName(), "category is empty"));
        assertTask(task, t -> !StringUtils.isEmpty(t.getNext())
    }
