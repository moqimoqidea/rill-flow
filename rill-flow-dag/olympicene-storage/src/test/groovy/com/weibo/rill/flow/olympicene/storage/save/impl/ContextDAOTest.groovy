...
class ContextDAOTest extends Specification {
    ...
    def "getContextNameToContentMap subContext value must be map"() {
        ...
        e.getErrorCode() == StorageErrorCode.CONTEXT_VALUE_MUST_BE_MAP.getCode()
    }
    ...
    def "deleteContext invoke setting if time above zero"() {
        ...
        when:
        contextDAOMock.deleteContext(executionId, 1)
    ...
    def "distinguishField check"() {
        ...
        contextDAO.distinguishField(rootContextFields, subContextNames, ["A", "B", "__C"])
